...
from solution_methods.GA_Multiobjective.src.operators import (
...
def initialize_run(jobShopEnv, **kwargs):
    ...
    toolbox.register("select", tools.selNSGA2, k=kwargs['algorithm']['population_size'])
    ...
    # Create Pareto Front to track the best individuals
